<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="LiuLangBookShop.WebUI.IndividualPage.Register" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="../html_css/register.css" rel="stylesheet" type="text/css" />
...
<body onkeydown="javascript:EnterKeyFilter();">
     <div class="text-center">
        <a href="../ContentPAge/Main.aspx"><img src="../images/book_title.png"  /></a>
    </div>
    <div class="container">
        <div id="form">
            <h1>用户注册<small>--流浪书店<asp:Label style="color: #FF0000" ID="ErrorInfo" runat="server" Text=""></asp:Label></small></h1>
            <br />
            <form class="form-horizontal" role="form" runat="server">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-7">
                        ...
                        <asp:HyperLink class="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="../IndividualPage/Login.aspx">已有账号？直接登录</asp:HyperLink>
                    </div>
                    <div class="col-sm-3">
