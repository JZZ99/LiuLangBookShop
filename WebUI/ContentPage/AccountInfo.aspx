<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.Master" AutoEventWireup="true" CodeBehind="AccountInfo.aspx.cs" Inherits="LiuLangBookShop.WebUI.ContentPage.AccountInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page_account" class="card">
            <br/>
        <div class="row">
            <div class="text-center">
                <h1>用户信息<small> --流浪书店 <asp:Label style="color: #FF0000" ID="ErrorInfo" runat="server" Text=""></asp:Label></small></h1>
            </div>
        </div>
            <br />
