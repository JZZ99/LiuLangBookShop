<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.Master" AutoEventWireup="true" CodeBehind="BookDetail.aspx.cs" Inherits="LiuLangBookShop.WebUI.ContentPage.BookDetial" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
         <link href="../html_css/bookDetail.css" rel="stylesheet" />
    <script>
        $(function () {
            // 数量减按钮
                    ...
                    <div class="col-md-offset-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <asp:HyperLink class="btn btn-link" ID="HyperLink1" runat="server" NavigateUrl="Cart.aspx">去购物车..</asp:HyperLink>
                            </div>
                        </div>
                        <br/>
                        <div>
