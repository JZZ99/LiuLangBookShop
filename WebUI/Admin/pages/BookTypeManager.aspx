<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookTypeManager.aspx.cs" Inherits="LiuLangBookShop.WebUI.Admin.pages.BookTypeManager" %>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">流浪书店-后台管理</a>
                </div>
                <!-- /.navbar-header -->
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li>
                                <asp:HyperLink NavigateUrl="~/Admin/pages/Login.aspx" ID="HyperLink1" runat="server"><i class="fa fa-sign-out fa-fw"></i> Logout</asp:HyperLink>
                            </li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
