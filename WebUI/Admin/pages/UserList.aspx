<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="LiuLangBookShop.WebUI.Admin.pages.UserList" %>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li>
                                <asp:HyperLink ID="Logout" runat="server" NavigateUrl="~/Admin/pages/Login.aspx"><i class="fa fa-sign-out fa-fw"></i> 退出</asp:HyperLink>
                            </li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
